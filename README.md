...
[Bicep and Arm Templates](https://docs.microsoft.com/en-us/azure/templates/microsoft.storage/storageaccounts?tabs=bicep)

### function tools

[function tools](https://github.com/Azure/azure-functions-core-tools/blob/dev/README.md)
